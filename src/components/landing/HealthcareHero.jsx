...
// Healthcare hero: calm, premium forest/cream with animated emerald/gold/coral
// orbs, a pulsing live badge + Oct 3 countdown, and three profile cards.
export default function HealthcareHero({ eyebrow, title, subtitle, price, priceNote, ctaLabel, cards }) {
  return (
    <section className="relative overflow-hidden bg-[#F7F3EA] px-5 pb-16 pt-32 lg:px-[8vw] lg:pb-24 lg:pt-40">
      <AnimatedShapes colors={['#1E8A70', '#C9A227', '#E9826B']} />
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="mt-8 flex justify-center">
          <SessionCountdown target={SESSION_DATE} accent="#1E8A70" variant="light" label="Live group session" />
        </div>
        <div className="mt-8 flex justify-center">
      ...
      {cards && (
        <div className="relative mx-auto mt-14 grid max-w-4xl gap-5 sm:grid-cols-3">
          {cards.map((c) => (
