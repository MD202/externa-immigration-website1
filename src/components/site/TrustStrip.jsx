...
export default function TrustStrip() {
  ...
  return (
    <div className="border-b border-[#123B2C]/10 bg-white py-5 shadow-sm">
      <div className="mx-auto flex max-w-[1440px] flex-wrap items-center justify-center gap-x-10 gap-y-3 px-5 text-sm text-[#123B2C]/70 lg:px-[8vw]">
