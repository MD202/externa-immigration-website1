    ...
    <section className="relative min-h-[680px] overflow-hidden bg-[#1E2A4A] text-white">
      ...
      <div className="relative mx-auto flex min-h-[680px] max-w-[1440px] items-center px-5 lg:px-[8vw]">
        <Reveal className="max-w-2xl">
          ...
          <Link to="/strategy-session" className="mt-9 inline-flex items-center gap-3 bg-[#4A0E0E] px-6 py-4 font-semibold text-[#FFFFFF] transition hover:bg-[#3A0808]">{t('business.cta')} <ArrowUpRight /></Link>
        </Reveal>
      </div>
    </section>
  );
