...
export default function Hero() {
  ...
  return (
    <section id="top" className="relative min-h-screen overflow-hidden bg-[#123B2C] text-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#123B2C] via-[#123B2C]/90 to-[#123B2C]/30" />
      <div className="relative mx-auto grid min-h-screen max-w-[1440px] items-center gap-12 px-5 pb-16 pt-32 lg:grid-cols-12 lg:px-[8vw]">
        <div className="lg:col-span-7">
          ...
          <div className="mt-9 flex flex-wrap gap-4">
            <Link to="/strategy-session" className="group flex items-center gap-3 bg-[#C9A227] px-6 py-4 font-semibold text-[#3D2F06] transition hover:bg-[#A8871A] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A227] focus-visible:ring-offset-2 focus-visible:ring-offset-[#123B2C]">{t('hero.cta1')} <ArrowUpRight className="transition-transform group-hover:-translate-y-1 group-hover:translate-x-1" aria-hidden="true" /></Link>
            <a href="#services" className="border border-white/30 px-6 py-4 font-semibold transition hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A227] focus-visible:ring-offset-2 focus-visible:ring-offset-[#123B2C]">{t('hero.cta2')}</a>
          </div>
        </div>
