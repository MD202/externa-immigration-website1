...
export default function ApproachSection() {
  ...
  return (
    <section id="approach" className="bg-white px-5 py-28 lg:px-[8vw] lg:py-40">
      <div className="mx-auto grid max-w-[1440px] gap-14 lg:grid-cols-12 lg:items-center">
        <div className="relative lg:col-span-6">
          ...
          <div className="absolute -bottom-8 -right-4 w-56 bg-[#0F2433] p-6 text-white lg:-right-10">
        ...
        <div className="lg:col-span-5 lg:col-start-8">
          ...
          <div className="mt-9 grid gap-5">
            {principles.map((item) => (
              <div key={item} className="flex gap-4 border-b border-[#0F2433]/10 pb-5">
                <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-[#C8102E]" />
                <span className="text-[#0F2433]/80">{item}</span>
              </div>
            ))}
          </div>
        </div>
