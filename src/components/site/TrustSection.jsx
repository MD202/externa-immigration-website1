...
export default function TrustSection() {
  const { t } = useLanguage();
  return (
    <section id="about" className="overflow-hidden bg-[#F5F1E8]">
      <div className="grid lg:grid-cols-2">
        <div className="flex items-center px-5 py-24 lg:px-[8vw] lg:py-36">
          <div className="max-w-xl">
            ...
            <a href={CICC_URL} target="_blank" rel="noopener noreferrer" className="mt-9 inline-flex items-center gap-3 border-l-2 border-[#A85638] pl-5 text-[#A85638] transition hover:gap-4">
