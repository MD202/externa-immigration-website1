...
export default function AppealsSection() {
  ...
  return (
    <section id="appeals" className="relative overflow-hidden bg-[#123B2C] px-5 py-28 text-white lg:px-[8vw] lg:py-40">
      <div className="absolute left-[8vw] top-0 h-full w-px bg-gradient-to-b from-transparent via-[#C9A227]/50 to-transparent" />
