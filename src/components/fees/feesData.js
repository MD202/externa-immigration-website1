...
export const services = [
  ...
  { id: 'prra', kind: 'tier', name: 'Pre removal risk assessment', full: '$4,800', diy: 'N/A', review: '$1,200', tabs: ['status'] },
  ...
  { id: 'admissibility', kind: 'hearing', name: 'Admissibility hearing', written: 'N/A', full: '$4,500', tabs: ['hearings'] },
  ...
  { id: 'start-up-visa', kind: 'tier', name: 'Startup visa', full: '$6,500', diy: '$3,900', review: '$1,200', tabs: ['business'] },
