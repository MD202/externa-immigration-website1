...
export default function ServiceStep({ data, setData }) {
  const { t } = useLanguage();
  const services = [
    { id: 'quick_question', label: 'Quick sync', duration: '15 minutes', price: '$50 +HST', desc: 'One specific question.' },
    { id: 'full_consultation', label: 'Full consultation', duration: '60 minutes', price: '$175 +HST', desc: 'A full assessment and a written summary afterward. Credited in full toward any package if you retain us within 15 days.', badge: 'Most people start here' },
  ];
  return (
    <div>
