    ...
    <main className="overflow-hidden bg-[#F8FAFC]">
      ...
      <section className="px-5 pt-32 pb-20 lg:px-[8vw] lg:pt-40">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-6 max-w-2xl border-l-2 border-[#C9A227] bg-[#F8FAFC] px-5 py-4">
            <p className="text-sm leading-relaxed text-[#1E2A4A]/70">{t('fees.stagedNote')}</p>
          </div>
          <Link to="/strategy-session" className="mt-8 inline-flex items-center gap-3 bg-[#C9A227] px-6 py-4 font-semibold text-[#FFFFFF] transition hover:bg-[#A8871A]">{t('fees.cta')} <ArrowUpRight /></Link>
        </div>
      </section>
      <Footer />
      <WhatsAppWidget />
