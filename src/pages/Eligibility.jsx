    ...
    <main className="min-h-screen bg-[#F8FAFC]">
      ...
      <section className="px-5 pt-32 pb-20 lg:px-[8vw] lg:pt-40">
        <div className="mx-auto max-w-3xl">
          <Link to="/" className="mb-10 inline-flex items-center gap-2 text-sm text-[#1E2A4A]/55 transition hover:text-[#C9A227]">
          ...
          {!isResult ? (
            <div className="mt-12">
              ...
              <div className="mt-8 grid gap-3">
                {QUESTIONS[step].options.map((opt) => (
                  <button key={opt} type="button" onClick={() => choose(QUESTIONS[step].key, opt)} className="flex items-center justify-between gap-4 border border-[#1E2A4A]/10 bg-white px-6 py-5 text-left transition hover:border-[#C9A227] hover:shadow-md">
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 border-l-2 border-[#C9A227] bg-white px-5 py-4 text-sm italic leading-relaxed text-[#1E2A4A]/60">{t('eligibility.resultNote')}</p>
              ...
              <form onSubmit={submit} className="bg-white p-8 shadow-sm">
                ...
                <button type="submit" disabled={saving} className="mt-7 flex w-full items-center justify-center gap-2 bg-[#C9A227] px-6 py-4 font-semibold text-[#FFFFFF] transition hover:bg-[#A8871A] disabled:opacity-50">
