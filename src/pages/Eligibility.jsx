    ...
    <main className="min-h-screen bg-[#F5F1E8]">
      ...
      <section className="px-5 pt-32 pb-20 lg:px-[8vw] lg:pt-40">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[#0E3B3B]/65">{t('eligibility.subtitle')}</p>
          ...
          {!isResult ? (
            <div className="mt-12">
              ...
              {step > 0 && (
                <button type="button" onClick={() => setStep(step - 1)} className="mt-8 flex items-center gap-2 text-sm text-[#0E3B3B]/55">
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              ...
              <form onSubmit={submit} className="bg-white p-8 shadow-sm">
                <h3 className="font-heading text-2xl text-[#0E3B3B]">{t('eligibility.formTitle')}</h3>
                <p className="mt-2 text-sm leading-relaxed text-[#0E3B3B]/55">{t('eligibility.formSubtitle')}</p>
