        ...
        <section className="flex items-center px-5 py-10 sm:px-12 lg:px-[8vw]">
          <div className="mx-auto w-full max-w-2xl">
            ...
            <div className="mt-9 flex items-center justify-between">
              ...
              {step < 3 && (
                <button type="button" disabled={!canProceed} onClick={() => setStep(step + 1)} className="flex items-center gap-3 bg-[#4A0E0E] px-6 py-4 font-semibold text-[#FFFFFF] transition hover:bg-[#3A0808] disabled:opacity-40">
