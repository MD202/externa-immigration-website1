    ...
    <main className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="grid gap-12 lg:grid-cols-[60%_40%]">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-[#1E2A4A]/65">{t(svc.textKey)}</p>
              <p className="mt-5 text-base leading-relaxed text-[#1E2A4A]/55">{t(svc.blurbKey)}</p>
              <div className="mt-10">
                <p className="text-xs font-semibold uppercase tracking-[.18em] text-[#1E2A4A]/50">{t('services.potentialSteps')}</p>
              ...
              <div className="mt-10 border-t border-[#1E2A4A]/10 pt-6">
                ...
                <p className="mt-3 text-sm text-[#1E2A4A]/60">{t(svc.factorsKey)}</p>
              </div>
            </div>
            {/* Right: contact form */}
            <div className="bg-white p-8 shadow-sm lg:sticky lg:top-32 lg:self-start">
              ...
              <Link to="/strategy-session" className="mt-5 flex items-center justify-center gap-3 bg-[#4A0E0E] px-6 py-4 font-semibold text-[#FFFFFF] transition hover:bg-[#3A0808]">
      ...
      <section aria-label="Frequently asked questions" className="bg-white px-5 py-20 lg:px-[8vw]">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mt-12 max-w-3xl divide-y divide-[#1E2A4A]/10 border-y border-[#1E2A4A]/10">
            {faqs.map((item, i) => (
              <div key={i}>
